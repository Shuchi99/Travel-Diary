...
const Login = () => {
  ...
  return (
    <div className='h-screen flex flex-col lg:flex-row items-center justify-center bg-cover bg-center px-5 lg:px-20' style={loginStyle}>
      ...
      <div className='w-full max-w-md lg:w-1/2 bg-white p-6 lg:p-10 rounded-lg shadow-lg relative overflow-hidden' 
      style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.9) 0%, rgba(230,230,230,0.9) 100%)", backdropFilter: "blur(10px)", border: "1px solid rgba(255,255,255,0.5)" }}>
